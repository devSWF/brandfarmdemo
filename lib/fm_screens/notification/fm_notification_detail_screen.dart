...
class FMNotificationDetailScreen extends StatefulWidget {
  @override
  _FMNotificationDetailScreenState createState() => _FMNotificationDetailScreenState();
}

class _FMNotificationDetailScreenState extends State<FMNotificationDetailScreen> {
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        SizedBox(
                            ...
                            child: FittedBox(
                                child:
                                DepartmentBadge(department: state.notice.department))),
                        SizedBox(
                          width: 5,
                        ),
                        Center(
                    ...
                    SizedBox(height: 19,),
                    Text(
                      '${getTime(date: state.notice.scheduledDate)} - ${from(state.notice.department)}',
