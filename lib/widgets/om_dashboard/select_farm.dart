  ...
  Widget build(BuildContext context) {
    return BlocConsumer<OMHomeBloc, OMHomeState>(
      ...
      builder: (context, state) {
        return (state.currentFarmIndex != null)
            ? Row(
                ...
                children: [
                  Container(
                    ...
                    child: Row(
                      children:
                          List.generate(state.farmList.length ?? 1, (index) {
                        return Row(
                          children: [
                            InkWell(
                              onTap: () {
                                _omHomeBloc
                                    .add(ChangeCurrFarmIndex(index: index));
                              },
                              child: Container(
                                width: 170,
                                height: 32,
                                decoration: BoxDecoration(
                                    ...
                                    border: Border.all(
                                        width: (state.currentFarmIndex == index)
                                            ? 3
                                            : 1,
