...
class OMSmallCalendar extends StatefulWidget {
  final int category;
  ...
  @override
  _OMSmallCalendarState createState() => _OMSmallCalendarState();
}

class _OMSmallCalendarState extends State<OMSmallCalendar> {
              ...
              return Row(
                ...
                children: List.generate(
                    ...
                    (row) => InkResponse(
                          onDoubleTap: () async {
                            if (widget.category == 1) {
                              _omPlanBloc.add(SetStartDate(
                                  startDate: monthList[row + current].date));
                              Navigator.pop(context);
                              await _showDatePicker(2);
                            } else {
                              _omPlanBloc.add(SetEndDate(
                                  endDate: monthList[row + current].date));
                              Navigator.pop(context);
                            }
                          },
                          onTap: () {
