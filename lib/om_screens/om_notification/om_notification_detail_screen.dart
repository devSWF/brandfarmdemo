...
class OMNotificationDetailScreen extends StatefulWidget {
  @override
  _OMNotificationDetailScreenState createState() =>
      _OMNotificationDetailScreenState();
}

class _OMNotificationDetailScreenState
    extends State<OMNotificationDetailScreen> {
                      ...
                      SizedBox(
                          ...
                          child: FittedBox(
                              child: DepartmentBadge(
                                  department: state.notice.department))),
                      SizedBox(
                        width: 5,
                      ),
                      Center(
